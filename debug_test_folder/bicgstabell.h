...
#define BICGSTABL_IN_LIBRARY 0 //1 is needed to have bicgstab(L) compile with Eigen, as part of the library for the unit tests. 0 to have it as a plugin for the test suite and in Plasimo.
