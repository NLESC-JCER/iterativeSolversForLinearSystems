...
#This was pointing to the wrong location for the include path!
g++ eigen_bicgstab.cpp -std=c++1z -I../eigen_test_folder -g -Wall -O3 -D PRECONDITIONER="Eigen::DiagonalPreconditioner<T>" -D ALGORITHM=2 -D DEBUG=0 -D ELL=4 -D MAJORITY=Eigen::RowMajor -o bicgstabell_test.out
